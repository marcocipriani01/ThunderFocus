package marcocipriani.openfocuser.manager.updater;
...
/**
 * AVR Hex firmware uploader/updater utility.
 *
...
public class Updater {
    ...
    public Updater(AvrdudeListener listener) throws IOException {
        InputStream fwStream = getClass().getResourceAsStream("/marcocipriani/openfocuser/manager/updater/firmwares");
        ...
        InputStream stream = getClass().getResourceAsStream("/marcocipriani/openfocuser/manager/updater/boards");
        ...
        InputStream cStream = getClass().getResourceAsStream("/marcocipriani/openfocuser/manager/updater/avrdude.conf");
        ...
        if (Utils.COMPUTER_OS.isUnix) {
            avrdude = "avrdude";

        } else if (Utils.COMPUTER_OS == Utils.OperatingSystem.Windows) {

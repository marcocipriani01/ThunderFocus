...
static volatile int8_t Channel[_Nbr_16timers];  // counter for the servo being pulsed for each
...
bool ServoHack::attached() { return servos[this->servoIndex].Pin.isActive; }
